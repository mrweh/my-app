...
export default function Economy () {
    ...
    const getData = async () => {
        const data = await getArticlesByTag('economic/economic', 2);
    ...
    return (
        <>
            <Text bgGradient='linear(to-l, #7928CA, #FF0080)' bgClip='text' fontWeight='extrabold' align='center'>Economy</Text>
